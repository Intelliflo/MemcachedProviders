...
namespace MemcachedProviders.Cache
{
    public class MemcachedCacheProvider : CacheProvider
    {
        ...
        private CacheCounters counters = new CacheCounters();
        ...
        {
            counters.IncrementTotalOperPc();
            return (long)this._client.Increment(_strKeySuffix +strKey, 1, (ulong)lAmount);
        }

        public override long Decrement(string strKey, long lAmount)
        {
            counters.IncrementTotalOperPc();
            return (long)this._client.Decrement(_strKeySuffix + strKey, 0, (ulong)lAmount);
        }
        #endregion
    }
}
